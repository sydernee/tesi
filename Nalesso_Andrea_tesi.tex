...
\input{capitoli/analisi-requisiti}             %Analisi dei requisiti
\input{capitoli/introduzione-IR}          % Introduzione al recupero dell'informazione
\input{capitoli/latent-semantic-indexing} % Introduzione all'analisi della semantica latente
\input{capitoli/progettazione-sviluppo}             % 
...
\appendix                               
\input{capitoli/esempi-errori}             % Esempi di errori di trascrizione
\input{capitoli/esempio-tesauro-gen.tex}
\input{capitoli/esempi-test}
